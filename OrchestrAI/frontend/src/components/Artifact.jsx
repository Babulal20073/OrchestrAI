import { Check, Code2, Copy, Eye, PanelRight, PanelRightClose, PanelRightOpen } from 'lucide-react'
...
const detectLanguage = (fileName = "") => {
  ...
  return (
    ...
    className='hidden lg:flex h-full border-1 border-white/[0.06] flex-col
    overflow-hidden shrink-0 w-auto'>
      <div className="flex flex-col h-full bg-[#0d0f14]">
        ...
        <div className="hidden lg:flex h-full border-1 border-white/[0.06] bg-[#0d0f14] flex-col items-center py-4 gap-3 shrink-0">
          ...
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <div 
            className="text-[13px] font-medium text-slate-600 tracking-widest uppercase whitespace-nowrap"
            style={{
